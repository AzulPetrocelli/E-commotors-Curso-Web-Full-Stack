...
<body class="bg-danger">
    <form action="" method="" class="form-welcome w-25">
        ...
        <label for=""><input type="text" class="input-form" placeholder="Usuario" name="" id=""></label>
        <label for=""><input type="password" class="input-form" placeholder="Contraseña" name="" id=""></label>
