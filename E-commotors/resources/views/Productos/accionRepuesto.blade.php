...
<div style="width: 90%; overflow-x: auto; overflow-y: auto; height:80vh" class="m-auto">
    <table class="table">
        ...
        <tbody>
            ...
            <tr class="fila-abm">
                <th scope="row">
                    <img src="{{ $repuesto->foto_repuesto ? asset('images/'.$repuesto->foto_repuesto) : asset('images/default-repuesto.jpg') }}" alt="Foto Repuesto" class="img-abm">
                </th>
                <td><div class="overflow-hidden" style="height: 80px">{{$repuesto->nombre_repuesto}}</div></td>
                <td><div class="overflow-hidden" style="height: 80px">{{$repuesto->precio_repuesto}}</div></td>
                <td><div class="overflow-hidden" style="height: 80px">{{$repuesto->tipo_de_repuesto->nombre_repuesto}}</div></td>
                <td><div class="overflow-hidden" style="height: 80px">{{$repuesto->descripcion_repuesto}}</div></td>
