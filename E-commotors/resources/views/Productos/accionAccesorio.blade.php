...
<body>
    <table class="table" >
        ...
        <tbody>
            ...
            <tr>
                <th scope="row">
                    <img src="{{ $accesorio->foto_accesorio ? asset('images/'.$accesorio->foto_accesorio) : asset('images/default-accesorio.jpg') }}" alt="Foto Accesorio" style="width: 100px; height: auto;">
                </th>
